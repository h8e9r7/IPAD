...
class Transformer(nn.Module):
    ...
    def forward(self, x, a):
        ...
        B, N, _ = x_output.shape
        # Type embedding
        a_type = self.type_embed[:,0]
        # print('a.shape', a.shape)
        # print('a_type.shape', a_type.shape)
        a = a + a_type
...
class Encoder(nn.Module):
    def __init__(self, num_layers,embed_size,mlp_dim,dropout_rate,num_heads,att_dropout_rate):
        ...
        self.part_layer = Block(embed_size,mlp_dim,dropout_rate,num_heads,att_dropout_rate)
        self.part_norm = LayerNorm(embed_size, eps=1e-6)
